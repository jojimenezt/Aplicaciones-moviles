...
class AndroidTicTacToeActivity : AppCompatActivity() {
                ...
                if(playerMove){
                    when (winner) {
                        ...
                        2 -> {
                            ...
                            mInfoTextView.text = "Android ganó!"
                            mGameOver = true
                        }
                    }
                }
    ...
    private fun  startNewGame() {
        ...
        when(mGame.getDifficultyLevel()){
            ...
            TicTacToeGame.DifficultyLevel.Harder->{mDifficultyTextView.text = "La dificultad es mediana"}
            TicTacToeGame.DifficultyLevel.Expert->{mDifficultyTextView.text = "La dificultad es dificil"}
        }
